...
This is as opposed to the main docs or "guides", which are for guides, ADRs, FAQs, etc.  They are intended as a point in time record of the current state of the repository at the given commit.  A new developer would skip the blog and just jump into the project.
