...
type SiteSiteMetadata = {
  ...
  readonly helpUrl: Maybe<Scalars['String']>;
...
type MdxFrontmatter = {
  ...
  readonly collapsedByDefault: Maybe<Scalars['Boolean']>;
};
...
type MdxFrontmatterFilterInput = {
  ...
  readonly metaTitle: Maybe<StringQueryOperatorInput>;
  readonly metaDescription: Maybe<StringQueryOperatorInput>;
  readonly navOrder: Maybe<IntQueryOperatorInput>;
  readonly collapsedByDefault: Maybe<BooleanQueryOperatorInput>;
};
...
type FileFieldsEnum =
  ...
  | 'childrenMdx.frontmatter.navOrder'
  | 'childrenMdx.frontmatter.collapsedByDefault'
  | 'childrenMdx.slug'
  | 'childrenMdx.body'
  | 'childrenMdx.excerpt'
  ...
  | 'childMdx.frontmatter.navOrder'
  | 'childMdx.frontmatter.collapsedByDefault'
  | 'childMdx.slug'
  | 'childMdx.body'
  | 'childMdx.excerpt'
  | 'childMdx.headings'
...
type SiteSiteMetadataFilterInput = {
  readonly title: Maybe<StringQueryOperatorInput>;
  readonly description: Maybe<StringQueryOperatorInput>;
  readonly docsLocation: Maybe<StringQueryOperatorInput>;
  ...
  readonly helpUrl: Maybe<StringQueryOperatorInput>;
...
type SiteFieldsEnum =
  ...
  | 'siteMetadata.logo.link'
  | 'siteMetadata.logo.image'
  | 'siteMetadata.headerTitle'
  | 'siteMetadata.helpUrl'
...
type SitePageContextFilterInput = {
  readonly id: Maybe<StringQueryOperatorInput>;
  readonly document: Maybe<StringQueryOperatorInput>;
};
...
type LocalSearchPagesSortInput = {
  readonly fields: Maybe<ReadonlyArray<Maybe<LocalSearchPagesFieldsEnum>>>;
  readonly order: Maybe<ReadonlyArray<Maybe<SortOrderEnum>>>;
};
...
type MdxFieldsEnum =
  ...
  | 'frontmatter.collapsedByDefault'
  | 'slug'
  | 'body'
  | 'excerpt'
  | 'headings'
...
type SitePluginFieldsEnum =
  ...
  | 'pluginOptions.gatsbyRemarkPlugins.options.sizeByPixelDensity'
...
type appsrctemplatesdocsJs3202592440QueryVariables = Exact<{
  id: Scalars['String'];
}>;


type appsrctemplatesdocsJs3202592440Query = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title' | 'docsLocation'>> }>, readonly mdx: Maybe<(
    Pick<Mdx, 'body' | 'tableOfContents'>
    & { readonly fields: Maybe<Pick<MdxFields, 'id' | 'title' | 'slug'>>, readonly parent: Maybe<Pick<File, 'relativePath'>>, readonly frontmatter: Maybe<Pick<MdxFrontmatter, 'title' | 'metaTitle' | 'metaDescription'>> }
  )>, readonly allMdx: { readonly edges: ReadonlyArray<{ readonly node: { readonly fields: Maybe<Pick<MdxFields, 'slug' | 'title'>>, readonly parent: Maybe<Pick<File, 'id' | 'name' | 'absolutePath' | 'sourceInstanceName'> | Pick<Directory, 'id'> | Pick<Site, 'id'> | Pick<SiteFunction, 'id'> | Pick<SitePage, 'id'> | Pick<LocalSearchPages, 'id'> | Pick<Mdx, 'id'> | Pick<SitePlugin, 'id'> | Pick<SiteBuildMetadata, 'id'>> } }> } };
...
type headerTitleQueryQueryVariables = Exact<{ [key: string]: never; }>;


type headerTitleQueryQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<(
      Pick<SiteSiteMetadata, 'headerTitle' | 'helpUrl'>
      & { readonly logo: Maybe<Pick<SiteSiteMetadataLogo, 'link' | 'image'>> }
    )> }>, readonly localSearchPages: Maybe<Pick<LocalSearchPages, 'index' | 'store'>> };

type Unnamed_1_QueryVariables = Exact<{ [key: string]: never; }>;


type Unnamed_1_Query = { readonly allMdx: { readonly edges: ReadonlyArray<{ readonly node: (
...
type Unnamed_2_Query = { readonly allMdx: { readonly edges: ReadonlyArray<{ readonly node: { readonly fields: Maybe<Pick<MdxFields, 'slug' | 'title'>>, readonly frontmatter: Maybe<Pick<MdxFrontmatter, 'collapsedByDefault' | 'navOrder'>>, readonly parent: Maybe<Pick<File, 'id' | 'name' | 'sourceInstanceName'>> } }> } };
